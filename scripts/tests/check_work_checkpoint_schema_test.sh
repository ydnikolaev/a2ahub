...
workreport_mode_valid="$WORK/workreport-mode-valid"
copy_tree "$workreport_mode_valid"
target="$workreport_mode_valid/internal/workreport/types.go"
perl -0pi -e 's/case ModePlanning, ModeImplementing/case ModeImplementing/' "$target"
expect_red "$workreport_mode_valid" "workreport Mode Valid behavior" "workreport mode runtime drift"
...
perl -0pi -e 's/case ModePlanning, ModeImplementing/case "designing", ModePlanning, ModeImplementing/' "$target"
expect_red "$workreport_mode_widen" "workreport Mode Valid behavior" "workreport mode runtime widening"
