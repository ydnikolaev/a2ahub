...
PRIVATE_ONLY_FILES=( .github/dependabot.yml scripts/check-feature-lint.sh scripts/check-feedback-corpus.sh scripts/check-notify-secrets.sh scripts/check-notify-workflow.sh scripts/check-skill-citations.sh scripts/check-spec-verify-refs.sh )
