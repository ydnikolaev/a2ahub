...
- **Epic [v1-min](features/v1-min-2026-07/README.md)** — space + `a2a` binary
  ...
  from the plan 2026-07-21; wave 1 shipped 2026-07-21 (P1 foundation, P2
  schemas; three A2-examples plan-corpus defects repaired en route).
  <!-- epic-state: v1-min-2026-07 phases=2/14 -->
