...
- **Code track — P13 (skill) is the ONLY remaining v1-min code phase.**
  **Catalog-seam fork RESOLVED + SHIPPED (wave 7a, 2026-07-22).** The design
  ...
  generated from the binary. **Remaining for P13 → done: (7b) the
  hand-maintained prose** (`SKILL.md`, `loops.md`, `troubleshooting.md`,
  `onboarding.md`, `decompose-example.md`, `RELEASE-CHECKLIST.md`) — deferred by
  operator to a later pass. The `skill-drift` CI job is lead-wired at 7a close.
