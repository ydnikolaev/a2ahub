...
- `doctor` — run local health checks over every connected space (credentials, mirror access, identity, versions, CI, space scaffolding, auto-merge, CODEOWNERS, statusline, skill) — see troubleshooting.md for what each FAIL means
...
- `a2a_whatsnew` — release directives: what changed and what to do — optional since=<version>
