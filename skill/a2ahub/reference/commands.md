...
- `doctor` — run local health checks over every connected space (credentials, mirror access, identity, participant avatars, versions, CI, space scaffolding, auto-merge, CODEOWNERS, notifications, statusline, skill) — see troubleshooting.md for what each FAIL means
