...
- `doctor` — run local health checks over every connected space (credentials, mirror access, identity, versions, CI, auto-merge, statusline, skill) — see troubleshooting.md for what each FAIL means
