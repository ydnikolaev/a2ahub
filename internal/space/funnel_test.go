...
func TestFunnelOperationRetryReturnsOriginalIDsAcrossDateChange(t *testing.T) {
	...
	first.OperationKey = operation.Respond(
		"axon", "agent", "bot", []string{"XQ-peer-20260729-parent"}, "answered", nil, nil, []byte("same"), operation.RespondIncompleteness{}, nil,
	)
...
func TestFunnelOperationRetryRecognizesMergedRemoteDespiteStaleLocalIntent(t *testing.T) {
	...
	req.OperationKey = operation.Respond("axon", "agent", "bot", []string{"XQ-peer-parent"}, "answered", nil, nil, nil, operation.RespondIncompleteness{}, nil)
