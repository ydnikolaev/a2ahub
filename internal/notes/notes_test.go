...
func TestLoad_CorpusIntegrity(t *testing.T) {
	...
	if len(all) != 17 {
		t.Fatalf("Load returned %d entries, want 16: %+v", len(all), all)
	}
	...
	wantVersions := []string{"0.2.0", "0.3.0", "0.4.0", "0.5.0", "0.6.0", "0.6.1", "0.6.2", "0.6.3", "0.6.4", "0.7.0", "0.8.0", "0.9.0", "0.9.1", "0.10.0", "0.11.0", "0.12.0", "0.13.0"}
	for i, rn := range all {
