	...
	snapshot := Snapshot{
		...
		Timeline: []TimelineRow{{
			...
			Work: []Work{{
				...
				Freshness: FreshnessLocalCurrent, Current: true, ReportedAt: &syncedAt, ObservedAt: &at, ValidUntil: &validUntil, Source: "local-lease",
